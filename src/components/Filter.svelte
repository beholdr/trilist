...
<div class="mb-4 flex">
  ...
  />
  <button
    class="form-button px-2 border border-l-0 flex items-center justify-center text-trilist-icon hover:text-trilist-hover border-trilist-input bg-trilist-fone active:bg-trilist-secondary"
    title="Expand all"
  ...
  <button
    class="form-button rounded rounded-l-none px-2 border border-l-0 flex items-center justify-center text-trilist-icon hover:text-trilist-hover border-trilist-input bg-trilist-fone active:bg-trilist-secondary"
    title="Collapse all"
